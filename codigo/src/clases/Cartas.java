...
public class Cartas {
    ...
    static Cartas carta20 = new Cartas(350,700,"imagenes/Ferb.png","Ferb","Enemigo",0);
    ...
    static Cartas cartaPoderzote = new Cartas(0,600,"imagenes/Poderzote.png","Poderzote","Enemigo",3);
    ...
    static Cartas cartaBlocito = new Cartas(0,0,"imagenes/Blocito.png","cartaBlocito","Enemigo",0,"bloqueo");
